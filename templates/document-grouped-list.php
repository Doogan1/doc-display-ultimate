...
/**
 * Recursively render folder groups for list layout
 */
if (!function_exists('renderFolderGroupsList')) {
    function renderFolderGroupsList($folder_groups, $atts, $level = 0, $accordion_states = array()) {
                ...
                <div class="filebird-docs-accordion-content <?php echo $is_open ? 'filebird-docs-accordion-open' : ''; ?>" <?php echo !$is_open ? 'style="display: none;"' : ''; ?>>
                    ...
                    <?php if (!empty($folder_group['children'])): ?>
                        <div class="filebird-docs-nested-folders">
                            <?php renderFolderGroupsList($folder_group['children'], $atts, $level + 1, $accordion_states); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
